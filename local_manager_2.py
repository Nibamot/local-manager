...
general_log = logger_setup(' Local Manager 2 ','/logs/lm2.log')
time_log = logger_setup(' Timing Local Manager 2 ','/logs/lm2time.log')
...
def change_ep_of_car(bjson):
    ...
    try:
        response = http_client.fetch("http://response-router-2-service.clm-test.empower:3001/api/item/from_local_mgr_api/21"\
...
if __name__ == '__main__':
  ...
  app = make_app()
  app.listen(3501)
  print("Started Local Manager 2 REST Server")
